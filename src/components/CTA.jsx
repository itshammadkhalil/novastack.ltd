    ...
    <section id="cta" className="relative py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            READY TO TRANSFORM YOUR <span className="text-accent-purple">DIGITAL PRESENCE</span>?
          </h2>
          <p
            className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto"
          >
           Whether it´s a high-end website, a custom web application, or seamless business automation also we build the tech that helps you grow. Let´s create something exceptional together.
          </p>
          <div>
            <Button
